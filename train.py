...
num_classes = 2
image_size = (512, 512)
base_dir = './data/polyp/'   # polyp, idrid, skin 900
dataset = 'polyp' 
train_num = 800  
max_epoch = 92

model = TransUNet(image_size[0],num_classes) #resnet34_UNet  PSPNet  DeepLabv3  UNet_plus BoTNet TransUNet swin_unet MissFormer CVT_21  res34_swin_MS rest_base
...
for epoch_num in range(max_epoch):
    ...
    if epoch_num%3 == 0: 
        ...
        test_batch_size = 1
        save_dir='./result/'
        db_val = testBaseDataSets(base_dir+'test/', 'test.txt',image_size,dataset,transform=transforms.Compose([RandomGenerator()]))
        ...
        if dataset == 'idrid':
            ...
            print("MAE: ", "%.2f" % MAE,"  Recall: ", "%.2f" % Recall, " Pre: ", "%.2f" % Pre,
